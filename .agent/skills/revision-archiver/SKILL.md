...
## 2. 문서 4종의 공식 저장 경로
모든 문서는 생성 당일 날짜 기준의 한글 '연/월/일' 3단계 서브 폴더를 기계적으로 생성하여 보존합니다.
- **Plan (구현 계획서)**: `안티그래비티\plan\YYYY년\MM월\DD일\YYYY-MM-DD_[주제명]_R[N].md`
- **Task (작업 명세서)**: `안티그래비티\task\YYYY년\MM월\DD일\YYYY-MM-DD_[과업주제]_R[N].md`
- **Walkthrough (완료 보고서)**: `안티그래비티\walkthrough\YYYY년\MM월\DD일\YYYY-MM-DD_[주제명]_R[N].md`
- **Report (특별 분석 보고서)**: `안티그래비티\report\YYYY년\MM월\DD일\YYYY-MM-DD_[주제명]_R[N].md`
