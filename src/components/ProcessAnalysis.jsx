                    ...
                    <div className="h-[300px] w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={groupedData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                                ...
                                <XAxis dataKey="processName" axisLine={false} tickLine={false} tick={{ fontSize: 12, fill: '#64748b' }} />
                                ...
                                <Bar yAxisId="left" dataKey="inspected" name="검사수량" fill="#3b82f6" radius={[6, 6, 0, 0]} maxBarSize={60} />
                                <Bar yAxisId="right" dataKey="failed" name="부적합수량" fill="#ef4444" radius={[6, 6, 0, 0]} maxBarSize={60} />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                </div>
